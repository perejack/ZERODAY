import { BookOpen, GraduationCap, Users, Award, Calculator, Monitor, Brain, Target, BarChart } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

const combinations = [
  {
    title: "Mathematics / Physics",
    description: "Strong foundation in quantitative sciences"
  },
  {
    title: "Mathematics / Computer Science",
    description: "Modern computational and mathematical skills"
  },
  {
    title: "Physics / Chemistry",
    description: "Comprehensive physical sciences focus"
  },
  {
    title: "Physics / Computer Science",
    description: "Applied physics and computing"
  },
  {
    title: "Mathematics / Business Studies",
    description: "Quantitative business applications"
  },
  {
    title: "Computer Science / Business Studies",
    description: "Technology and business integration"
  }
];
...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "Educational management skills"
  },
  {
    icon: BarChart,
    title: "Career Growth",
        ...
        <div className="relative h-full flex items-center justify-center text-center">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-white mb-8 drop-shadow-lg">
              Shape the future through science education and leadership
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-md p-8 mb-8">
              ...
              <div className="prose max-w-none text-gray-600">
                <p>
                  The Bachelor of Education (Science) program aims to train professionally qualified teachers who are competent and skillful enough to teach and provide effective servant leadership and management at all levels of education in private, corporate and public service.
                </p>
                <p className="mt-4">
                  Our program focuses on building a broad foundation of theoretical and professional knowledge in education while simultaneously developing deep expertise in specific scientific disciplines. This dual focus ensures our graduates are well-prepared for both teaching and leadership roles in educational institutions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Subject Combinations</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">At least 4 credits in IGCSE with 2 credit passes at A level</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="bg-[#00BFFF]/10 p-2 rounded-lg mt-1">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Diploma in Education from recognized institution</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="bg-[#00BFFF]/10 p-2 rounded-lg mt-1">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">P1 Certificate with minimum C plain in KCSE</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#00BFFF] rounded-xl shadow-md p-6 text-white">
              ...
              <p className="mb-6">Begin your journey in education at Daystar University.</p>
              <button 
                onClick={() => {
                  navigate('/apply');
                  window.scrollTo(0, 0);
