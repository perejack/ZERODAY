import { Users, Award, Sprout, Target, Wheat, GraduationCap, Leaf, Globe } from 'lucide-react';
...
const agricultureAreas = [
  ...
  },
  {
    ...
    description: "Scientific foundations"
  },
  {
    title: "Communication",
        ...
        <div className="relative h-full flex items-center justify-center text-center">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-white mb-8 drop-shadow-lg">
              Cultivating sustainable food systems and rural development
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-md p-8 mb-8">
              ...
              <div className="prose max-w-none text-gray-600">
                <p>
                  Agriculture plays a central role in supplying food and providing raw materials for industry. Our Diploma in Agriculture program offers a comprehensive curriculum with a broad range of courses in basic sciences, technical agriculture, and communication.
                </p>
                <p className="mt-4">
                  The program prepares graduates to assume key positions in teaching, agricultural extension, and rural development. Students gain hands-on experience in modern farming techniques and sustainable agricultural practices.
                </p>
                <p className="mt-4">
                  Through a combination of theoretical knowledge and practical skills, our graduates become effective agents of change in agricultural development and food security initiatives.
                </p>
              </div>
            </div>
                ...
                {agricultureAreas.map((area, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="bg-[#00BFFF]/10 p-3 rounded-lg mt-1">
                      <Sprout className="w-5 h-5 text-[#00BFFF]" />
                    </div>
                    <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#00BFFF] rounded-xl shadow-md p-6 text-white">
              ...
              <p className="mb-6">Begin your journey in agriculture at Daystar University.</p>
              <button 
